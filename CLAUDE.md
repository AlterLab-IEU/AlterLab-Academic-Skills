...
> **Project**: AlterLab Academic Skills — 225 Claude AI skills for faculty and researchers
...
This project provides **225 professional Claude AI skills** organized into 17 domain categories for faculty members, academicians, and researchers. Each skill transforms Claude into a domain-specific expert assistant tailored to academic research, scientific computing, and scholarly publishing workflows.
...
| Social-Science Workflow | `skills/social-science-workflow/` | 4 | Stage-gated design/measurement/sampling/inference validity gates |

**Total: 225 skills across 17 categories**
