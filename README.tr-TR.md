...
<a href="skills/"><img src="https://img.shields.io/badge/Beceri-217-7C3AED?style=for-the-badge&logo=bookstack&logoColor=white" alt="Beceriler"></a>
...
<a href="docs/evals.md"><img src="https://img.shields.io/badge/Eval-217%2F217-16A34A?style=for-the-badge&logo=checkmarx&logoColor=white" alt="Eval kapsamı"></a>
...
<h3>🧬 Fakülte üyeleri, araştırmacılar ve akademisyenler için özel olarak tasarlanmış 217 Claude AI becerisi</h3>
<p><em>16 araştırma alanına yayılmış — Türk akademisinden biyoinformatiğe, dijital beşeri bilimlere</em></p>
<p><em>217/217 beceri çalıştırılabilir eval ile gelir · deterministik atıf-doğrulayıcı · claude.ai için alan paketleri</em></p>
...
- [📚 217 Becerinin Tamamı](#-217-becerinin-tamamı)
...
Fakülte üyeleri, akademisyenler ve araştırmacılar için tasarlanmış, **özel amaçlı 217 Claude AI becerisinden** oluşan kapsamlı bir paket — akademik araştırma yaşam döngüsünün tamamını kapsayacak şekilde **16 alan kategorisine** ayrılmıştır.
...
| | Özellik | Açıklama |
|:---:|:---|:---|
| ✅ | **Davranışsal Eval Kapsamı** | 217 becerinin **tamamı** (%100) Anthropic'in tetikleme/tetiklememe biçimini izleyen `evals/evals.json` dosyalarıyla gelir; `scripts/run_evals.py` ile çalıştırılır |
...
> [!NOTE]
> Eval kapsamı artık tüm koleksiyonu kapsar (217 / 217). Tam değişiklik geçmişi için [CHANGELOG.md](CHANGELOG.md) dosyasına bakın.
