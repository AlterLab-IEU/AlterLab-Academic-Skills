...
<a href="skills/"><img src="https://img.shields.io/badge/Beceri-232-7C3AED?style=for-the-badge&logo=bookstack&logoColor=white" alt="Beceriler"></a>
...
<a href="docs/evals.md"><img src="https://img.shields.io/badge/Eval-232%2F232-16A34A?style=for-the-badge&logo=checkmarx&logoColor=white" alt="Eval kapsamı"></a>
...
<h3>🧬 Fakülte üyeleri, araştırmacılar ve akademisyenler için özel olarak tasarlanmış 232 Claude AI becerisi</h3>
<p><em>17 araştırma alanına yayılmış — Türk akademisinden biyoinformatiğe, dijital beşeri bilimlere</em></p>
<p><em>232/232 beceri çalıştırılabilir eval ile gelir · deterministik atıf-doğrulayıcı · claude.ai için alan paketleri</em></p>
...
- [📚 232 Becerinin Tamamı](#-232-becerinin-tamamı)
...
Fakülte üyeleri, akademisyenler ve araştırmacılar için tasarlanmış, **özel amaçlı 232 Claude AI becerisinden** oluşan kapsamlı bir paket — akademik araştırma yaşam döngüsünün tamamını kapsayacak şekilde **17 alan kategorisine** ayrılmıştır.
...
| | Özellik | Açıklama |
|:---:|:---|:---|
| ✅ | **Davranışsal Eval Kapsamı** | 232 becerinin **tamamı** (%100) Anthropic'in tetikleme/tetiklememe biçimini izleyen `evals/evals.json` dosyalarıyla gelir; `scripts/run_evals.py` ile çalıştırılır |
...
> [!NOTE]
> Eval kapsamı artık tüm koleksiyonu kapsar (232 / 232). Tam değişiklik geçmişi için [CHANGELOG.md](CHANGELOG.md) dosyasına bakın.
...
| 🧭 | **Sosyal Bilim İş Akışı** | **11** | Aşamalı yöntem omurgası — orkestratör + 4 geçerlilik kapısı (tasarım, ölçüm, örnekleme, çıkarım) + 6 analiz modülü (nedensel çıkarım, YEM/psikometri, QCA, SNA, ABM, metin-veri) |
<br>
...
<b>232 beceri · 17 alan · 232'si çalıştırılabilir eval ile · uzman düzeyinde araştırmaya 1 komut uzaklıkta</b>
