...
- **240/240** skills: portable-core frontmatter only (`name`/`description` required; plus the `compatibility` convention).
- **232** bundle `references/*.md` — portable Markdown.
