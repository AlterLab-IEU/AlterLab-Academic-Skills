...
- **242/242** skills: portable-core frontmatter only (`name`/`description` required; plus the `compatibility` convention).
- **234** bundle `references/*.md` — portable Markdown.
- **132** bundle `scripts/*.py` — portable plain Python.
