...
> **Not yet checked by this scorer — the SCIE/SSCI ≥40-point minimum.** The live
> Sağlık criteria pair the "≥3 başlıca-yazar articles" rule with a **≥40 points
> from SCIE/SSCI articles** floor. This scorer enforces the *count* (≥3) but
> **not** that 40-point sub-total, and there are additional field-specific
> minimums (e.g. a TR Dizin national-article requirement, a citation minimum,
> a thesis-derived-points cap) it does not model. A `lead_q_articles >= 3` pass
> here is **necessary but not sufficient** — re-verify the full TABLO 10
> checklist against the live ÜAK source for the candidate's term.
