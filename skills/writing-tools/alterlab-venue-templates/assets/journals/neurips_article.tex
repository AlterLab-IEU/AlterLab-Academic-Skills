...
% Last updated: 2026-09 (NeurIPS 2026: 9 content pages, mandatory paper checklist)
% Note: Use the official neurips_2026.sty and checklist.tex from the conference website
% (Formatting_Instructions_For_NeurIPS_2026.zip); both change every year.

\documentclass{article}

% Required packages (neurips_2026.sty provides most formatting)
\usepackage{neurips_2026}  % Official NeurIPS style file (download from conference site)
% Track/camera-ready options, e.g. \usepackage[main, final]{neurips_2026} or [preprint]
...
% NeurIPS Paper Checklist -- mandatory; submissions without it are desk-rejected.
% It does not count toward the page limit. Copy checklist.tex from the official
% NeurIPS 2026 kit and answer every question.
% \input{checklist.tex}

\end{document}

% Notes for Authors:
% 1. Main paper: 9 pages maximum including figures (references, appendices, and the checklist do not count)
...
% 5. Complete the NeurIPS Paper Checklist (covers broader impacts and reproducibility)
% 6. Code submission strongly encouraged (anonymous for review)
% 7. Use official neurips_2026.sty file (download from NeurIPS website)
