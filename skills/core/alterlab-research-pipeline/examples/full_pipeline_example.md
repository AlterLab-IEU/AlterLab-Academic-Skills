...
```
Entering Stage 1 (RESEARCH) -- using alterlab-deep-research socratic mode

Loading alterlab-deep-research SKILL.md...
...
```
Entering Stage 2 (WRITE) -- using alterlab-paper-writer plan mode

Loading alterlab-paper-writer SKILL.md...
handoff materials: RQ Brief + Bibliography + Synthesis
intake_agent auto-detected alterlab-deep-research output, skipping redundant Phase 0 questions
...
alterlab-paper-writer draft_writer_agent writing based on Chapter Plan...
...
```
Entering Stage 3 (REVIEW) -- using alterlab-paper-reviewer full mode

Loading alterlab-paper-reviewer SKILL.md...
...
I'll pass the Revision Roadmap to alterlab-paper-writer revision mode,
...
```
Entering Stage 4 (REVISE) -- using alterlab-paper-writer revision mode

Loading alterlab-paper-writer SKILL.md (revision mode)...
...
```
Entering Stage 5 (FINALIZE) -- using alterlab-paper-writer format-convert mode

Loading alterlab-paper-writer SKILL.md (format-convert mode)...
...
- Revise again --> just say "revise the paper" (triggers alterlab-paper-writer revision mode)
