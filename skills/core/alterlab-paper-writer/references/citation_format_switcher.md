...
|--------|---------------|
| APA 7th | OpenAI. (2023). *ChatGPT* (Mar 14 version) [Large language model]. https://chat.openai.com/chat — APA Style's published pattern: developer, year of the version, tool name, version, bracketed description, URL |
...
| MLA 9th | "[Text of the prompt, or a description of it]" prompt. *ChatGPT*, 13 Feb. version, OpenAI, 8 Mar. 2023, chat.openai.com/chat. — MLA Style Center pattern |
...
Most journals also require an AI-use disclosure statement (methods or acknowledgments) in addition to, or instead of, a citation — check the target journal's policy.
